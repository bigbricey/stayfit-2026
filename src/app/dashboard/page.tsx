  ...
  if (!user) {
      return (
          <div className="flex h-screen items-center justify-center bg-black text-white font-mono flex-col gap-4">
              <div className="text-red-500">ACCESS DENIED: SESSION INVALID</div>
              <a href="/login" className="px-4 py-2 border border-cyan-500 text-cyan-500 hover:bg-cyan-500/10 transition-colors">
                  RETURN TO LOGIN
              </a>
          </div>
      )
