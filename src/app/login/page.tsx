...
function LoginForm() {
    ...
    useEffect(() => {
        if (urlError === 'auth_error') {
            ...
            setError('Session cookies missing. Please try again.');
    ...
    const handleEmailLogin = async (formData: FormData) => {
        ...
        try {
            ...
            // Server action will redirect on error, this catches unexpected issues
    ...
    return (
        <div className="w-full max-w-md">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-8">
                {/* Google Login - Using Server Action via form */}
                ...
                {/* Email Login Form - Using Server Action */}
